/**
 * Created on : 15-10-2024 04:00 pm
 */
...
public class DharaWTPHistory {

    @SerializedName("Data")
    private List<DharaWTPHistoryData> data;
    ...
    public List<DharaWTPHistoryData> getData() {
        return data;
    }
    ...
    public static class DharaWTPHistoryData{
